...
ES_t KPD_enum_Get_Key_State(u8 *Copy_pu8_Returned_Key){
 ...
 u8 Local_enu_Erorr_State = ES_OK ;
 u8 Local_u8_Rows_Counter, Local_u8_Cols_Counter, Local_u8_Pin_Value, Local_u8_Flag =DIO_u8_LOW;
 if (*Copy_pu8_Returned_Key != KPD_u8_Keys_NO_Pressed ){

...
//macros of port
#define STEPPER_MOTOR_BLUE_PORT    DIO_u8_PORTC
#define STEPPER_MOTOR_PINK_PORT    DIO_u8_PORTC
#define STEPPER_MOTOR_YELLOW_PORT  DIO_u8_PORTC
#define STEPPER_MOTOR_ORANGE_PORT  DIO_u8_PORTC

//macros of pins
#define STEPPER_MOTOR_BLUE_PIN    DIO_u8_PIN0
#define STEPPER_MOTOR_PINK_PIN    DIO_u8_PIN1
#define STEPPER_MOTOR_YELLOW_PIN  DIO_u8_PIN2

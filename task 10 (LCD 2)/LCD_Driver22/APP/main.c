...
int main(void){
	  u8 switchb0,switchb1,switchb2,switchb3 ;
	u8 counter=0;
	DIO_voidInit();
	LCD_enum_INIT();
	DIO_u8_Set_Pin_Direction(DIO_u8_PORTB, DIO_u8_PIN0, DIO_u8_INTIAL_INPUT);
	DIO_u8_Set_Pin_Direction(DIO_u8_PORTB, DIO_u8_PIN1, DIO_u8_INTIAL_INPUT);
	DIO_u8_Set_Pin_Direction(DIO_u8_PORTB, DIO_u8_PIN2, DIO_u8_INTIAL_INPUT);
	DIO_u8_Set_Pin_Direction(DIO_u8_PORTB, DIO_u8_PIN3, DIO_u8_INTIAL_INPUT);
...
//	  u8 stiker7[8] = { 0x00, 0x00, 0x0A, 0x00, 0x04, 0x11, 0x0E, 0x00 };
 ...
 //	  LCD_enum_Send_Custom_char(4 , stiker4);
	...
	while(1){
		...
		DIO_u8_Get_Pin_Value(DIO_u8_PORTB, DIO_u8_PIN0, &switchb0);
